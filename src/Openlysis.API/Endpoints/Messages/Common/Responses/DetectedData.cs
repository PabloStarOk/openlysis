...
{
    /// <summary>
    /// Creates a new instance of <see cref="DetectedData"/> from the provided <see cref="MessageAnalysis"/> source.
    /// </summary>
    /// <param name="source">The source object containing the results of message analysis.</param>
    /// <returns>A new <see cref="DetectedData"/> instance populated with detected URLs, email addresses, and phone numbers.</returns>
    public static DetectedData CreateFromMessageAnalysis(MessageAnalysis source)
    {
